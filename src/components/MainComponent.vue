        ...
        <section class="carousel_container">
            ...
            <div class="carousel">
                <div class="nav_carousel">
                    ...
                    <div v-for="(item, i) in carousel" :key="i" class="img_carousel"
                ...
                <div class="time_line_content">
                    ...
                    <div class="time_line_flex">
                        <div class="text_time_line">
                            <h4>Demo Classes</h4>
                            <p>In the first students try to accomodate with the teaching style and choose their optional
                                courses.</p>
                        </div>
                    ...
                    <div class="time_line_flex2">
                        <div class="text_time_line2">
                            <h4>Orientation</h4>
                            <p>First day of the universuty year, all students gather for the opening ceremony and then
                                network with
                                others.</p>
                        </div>
                        ...
                        <div class="text_time_line2">
                            <h4>Evaluation</h4>
                            <p>At the end of a semester, students take a general evaluation test for every subject
                                they're learning.
                            </p>
                        </div>
                    </div>
